...
test("Subscribe As Member - Plus", async ({ page }) => {
  await page.goto(
    getURL({
      isMember,
      isLive,
...
test("Subscribe As Member - Pro", async ({ page }) => {
  await page.goto(
    getURL({
      isMember,
      isLive,
...
test("Subscribe As Member - Credits", async ({ page }) => {
  await page.goto(
    getURL({
      isMember,
      isLive,
...
test("Subscribe As Member - Grape", async ({ page }) => {
  await page.goto(
    getURL({
      isMember,
      isLive,
...
test("Subscribe As Member - Pear", async ({ page }) => {
  await page.goto(
    getURL({
      isMember,
      isLive,
...
test("Subscribe As Member - Sushi (Coder)", async ({ page }) => {
  await page.goto(
    getURL({
      isMember,
      isLive,
...
test("Subscribe As Member - Watermelon", async ({ page }) => {
  await page.goto(
    getURL({
      isMember,
      isLive,
